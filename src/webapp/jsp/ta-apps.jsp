...
<div class="max-w-5xl mx-auto">
    ...
    <c:if test="${param.success == 'true'}">
        <div id="applySuccessModal" class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
            <div class="bg-white rounded-xl shadow-xl p-6 w-full max-w-sm text-center">
                <h3 class="text-xl font-bold text-green-700 mb-2">Application Successful</h3>
                <p class="text-slate-600 mb-4">Your application has been submitted.</p>
                <button type="button" onclick="document.getElementById('applySuccessModal').classList.add('hidden')" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">OK</button>
            </div>
        </div>
    </c:if>
